# OS.js Example Packages

This repository contains Example Applications for [OS.js](https://github.com/os-js/OS.js).
...
An Angular2 example app. See README in this folder for more info.
